          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 9;
                return axios__default["default"].post('/api/user/preference', formData)["catch"](function (error) {
                  // TODO: Handle errors
                  console.log(error);
                });
...
var DefaultToast = function DefaultToast(_ref3) {
  var _ref3$appearance = _ref3.appearance,
      ...
      UI = _ref3.UI,
      color = _ref3.color,
      otherProps = _objectWithoutProperties__default["default"](_ref3, _excluded3);

  var style = appearances[appearance];
  return /*#__PURE__*/React__default["default"].createElement(ToastElement, _extends__default["default"]({
  ...
  }, otherProps), appearance !== 'plain' ? /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    isRunning: isRunning
  }), /*#__PURE__*/React__default["default"].createElement(style.icon, null)) : null, /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, content) : null, action && secondaryAction ? /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, secondaryActionLabel)) : null), action && !secondaryAction ? /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    className: "font-bold",
    onClick: action
  }, actionLabel)) : null, onDismiss && secondaryAction !== 'dismiss' ? /*#__PURE__*/React__default["default"].createElement("div", {
    role: "button",
    ...
    onClick: onDismiss
  }, /*#__PURE__*/React__default["default"].createElement(CloseIcon, null), /*#__PURE__*/React__default["default"].createElement("span", {
    className: "sr-only"
  }, "Close")) : null);
};
...
var ToastController = /*#__PURE__*/function (_Component) {
  ...
  function ToastController() {
    ...
    _classCallCheck__default["default"](this, ToastController);
  ...
  _createClass__default["default"](ToastController, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.startTimer();
    }
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default["default"].createElement(Toast, _extends__default["default"]({
...
var ToastContext = /*#__PURE__*/React__default["default"].createContext();
...
var ToastProvider = /*#__PURE__*/function (_Component) {
  ...
  function ToastProvider() {
    ...
    _classCallCheck__default["default"](this, ToastProvider);
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "add", function (title, content) {
      ...
      _this.setState(function (state) {
        ...
        var toasts = _this.props.newestOnTop ? [newToast].concat(_toConsumableArray__default["default"](state.toasts)) : [].concat(_toConsumableArray__default["default"](state.toasts), [newToast]);
        return {
          toasts: toasts
        };
  ...
  _createClass__default["default"](ToastProvider, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      return /*#__PURE__*/React__default["default"].createElement(Provider, {
      ...
      }, children, portalTarget ? /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React__default["default"].createElement(ToastContainer, {
        className: containerClasses,
        placement: placement,
        hasToasts: hasToasts
      }, /*#__PURE__*/React__default["default"].createElement(TransitionGroup$1, {
        component: null
        ...
        return /*#__PURE__*/React__default["default"].createElement(Transition$1, {
          ...
          return /*#__PURE__*/React__default["default"].createElement(ToastController, _extends__default["default"]({
            appearance: appearance,
      ...
      }))), portalTarget) : /*#__PURE__*/React__default["default"].createElement(ToastContainer, {
        placement: placement,
        hasToasts: hasToasts
      }));
    }
...
_defineProperty__default["default"](ToastProvider, "defaultProps", {
  autoDismiss: false,
...
var ToastConsumer = function ToastConsumer(_ref2) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(Consumer, null, function (context) {
...
var withToastManager = function withToastManager(Comp) {
  return /*#__PURE__*/React__default["default"].forwardRef(function (props, ref) {
    return /*#__PURE__*/React__default["default"].createElement(ToastConsumer, null, function (context) {
...
var useToasts = function useToasts() {
  var ctx = React$1.useContext(ToastContext);
...
var WebAppsProvider = function WebAppsProvider(props) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return axios__default["default"].post('/api/setting', formData).then(function (json) {
      ...
      return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return axios__default["default"].get('/api/navigation').then(function (json) {
                if (!unmounted.current) {
      ...
      return _regeneratorRuntime__default["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return axios__default["default"].get('/api/apps').then(function (json) {
                if (!unmounted.current) {
            ...
            case 2:
              _context3.next = 4;
              return axios__default["default"].get('/api/online/apps/list').then(function (json) {
                if (!unmounted.current) {
      ...
      return _regeneratorRuntime__default["default"].wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return axios__default["default"].get('/api/plugins').then(function (json) {
                if (!unmounted.current) {
            ...
            case 2:
              _context4.next = 4;
              return axios__default["default"].get('/api/plugins/active').then(function (json) {
                if (!unmounted.current) {
            ...
            case 4:
              _context4.next = 6;
              return axios__default["default"].get('/api/online/plugins/list').then(function (json) {
                if (!unmounted.current) {
  ...
  var downloadApp = /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee5(e) {
      var formData;
      return _regeneratorRuntime__default["default"].wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 5;
              return axios__default["default"].post('/api/online/apps/download', formData).then(function (json) {
                if (!unmounted.current) {
  ...
  var updateApp = /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee6(e) {
      var formData;
      return _regeneratorRuntime__default["default"].wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
  ...
  var activateApp = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee7(e) {
      var formData;
      return _regeneratorRuntime__default["default"].wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 6;
              return axios__default["default"].post('/api/apps/control', formData).then(function (json) {
                if (!unmounted.current) {
  ...
  var deactivateApp = /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee8(e) {
      var formData;
      return _regeneratorRuntime__default["default"].wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
  ...
  var installApp = /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee9(e) {
      var formData;
  ...
  var uninstallApp = /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee10(e) {
      var formData;
  ...
  var downloadPlugin = /*#__PURE__*/function () {
    var _ref11 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee11(e) {
      var formData;
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              formData.append('slug', e.target.dataset.slug);
              _context11.next = 5;
              return axios__default["default"].post('/api/online/plugins/download', formData).then(function (json) {
                if (!unmounted.current) {
                  addToast(json.data.message, '', {
                    appearance: 'success'
                  });
  ...
  var updatePlugin = /*#__PURE__*/function () {
    var _ref12 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee12(e) {
      var formData;
  ...
  var togglePlugin = /*#__PURE__*/function () {
    var _ref13 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee13(e) {
      var formData;
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              ...
              formData.append('slug', e.target.dataset.slug);
              _context13.next = 5;
              return axios__default["default"].post('/api/plugins/toggle', formData).then(function (json) {
                if (!unmounted.current) {
  ...
  var uninstallPlugin = /*#__PURE__*/function () {
    var _ref14 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee14(e) {
      var formData;
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              formData.append('slug', e.target.dataset.slug);
              _context14.next = 6;
              return axios__default["default"].post('/api/plugin', formData).then(function (json) {
                if (!unmounted.current) {
                  addToast(json.data.plugin.name, json.data.message, {
                    appearance: 'success'
                  });
...
var AppActionButtons = function AppActionButtons(_ref) {
  ...
  }, "v", app.version || app.release.version)), /*#__PURE__*/React__default["default"].createElement("div", {
    className: "p-4"
...
var PluginActionButtons = function PluginActionButtons(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    className: "inline-block m-1 px-2 py-1 bg-gray-200 dark:bg-gray-900 text-gray-800 dark:text-gray-200 rounded-lg tracking-wide text-xs"
  }, "v", plugin.version || plugin.release.version)), /*#__PURE__*/React__default["default"].createElement("div", {
    className: "p-4"
  }, /*#__PURE__*/React__default["default"].createElement("h2", {
    className: "mb-2 font-bold"
