...
import React$1, { useState, useRef, useCallback, useEffect, useMemo, Children, isValidElement, cloneElement, Component, useContext, createRef } from 'react';
...
import { NavLink, useLocation, withRouter, Link as Link$1 } from 'react-router-dom';
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _ref5 = _args4.length > 2 && _args4[2] !== undefined ? _args4[2] : {}, customHeaders = _ref5.headers, _ref5$accept = _ref5.accept, accept = _ref5$accept === void 0 ? TYPE_JSON : _ref5$accept, customConfig = _objectWithoutProperties(_ref5, _excluded2$5);
            _context4.prev = 2;
            config = _objectSpread$8({
              method: data ? 'POST' : 'GET',
  ...
  _createClass$1(ToastController, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          props = _objectWithoutProperties(_this$props2, _excluded$p);
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React$1.createElement(Provider, {
        ...
        var appearance = _ref.appearance,
            ...
            unknownConsumerProps = _objectWithoutProperties(_ref, _excluded$o);
...
var NavDropdown = function NavDropdown(_ref) {
  ...
  var children = props.children,
      ...
      show = props.show,
      route = props.route;
      _objectWithoutProperties(props, _excluded2$3);
...
var NavItem = function NavItem(_ref) {
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    ...
    icon: icon,
    className: "h-6 w-6 mr-4"
  }), /*#__PURE__*/React$1.createElement("span", null, name), badge && /*#__PURE__*/React$1.createElement(Badge, _objectSpread$1(_objectSpread$1({}, badge), {}, {
    text: null
  }), badge.text)));
};
...
var Sidebar = function Sidebar(_ref) {
  ...
  return /*#__PURE__*/React$1.createElement(SidebarWrapper$1, null, navigation.menu !== null && navigation.menu !== undefined && !navigation.menu.error ? /*#__PURE__*/React$1.createElement(CreateElement, {
  ...
  _createClass$1(ComponentError, [{
    ...
    value: function render() {
      ...
      if (this.state.hasError) {
        ...
        }, "This failed to load!")), /*#__PURE__*/React$1.createElement("p", {
